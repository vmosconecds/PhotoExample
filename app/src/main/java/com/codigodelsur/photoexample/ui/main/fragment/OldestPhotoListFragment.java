...
import com.codigodelsur.photoexample.ui.main.viewmodel.OldestPhotoListViewModel;
...
public class OldestPhotoListFragment extends LifecycleFragment implements PhotoListCallback {

    @Inject
    OldestPhotoListViewModel photoListViewModel;

    FragmentPhotoListBinding binding;

    public static OldestPhotoListFragment newInstance() {
        Bundle args = new Bundle();
        OldestPhotoListFragment fragment = new OldestPhotoListFragment();
