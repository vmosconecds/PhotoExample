...
public class PopularPhotoListFragment extends LifecycleFragment implements PhotoListCallback {

    @Inject
    PopularPhotoListViewModel popularPhotoListViewModel;

    FragmentPhotoListBinding binding;

    public static PopularPhotoListFragment newInstance() {
        Bundle args = new Bundle();
        PopularPhotoListFragment fragment = new PopularPhotoListFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        popularPhotoListViewModel.getPhotos().observe(this, listResource -> binding.setResource(listResource));
